...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // get the post id of new created post
    // upload image to the firebase with post id
    // get a download url from fb and update the original post with image
    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="flex items-center justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          {/* This element is to trick th browser into centering the modal content.*/}
          <span
          ...
          <Transition.Child
            ...
            enterTo="opactiy-100 translate-y-0 sm:scale-100"
            leave="ease-in duration-300"
